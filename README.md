...
- **Environment Variables (P3)**: Use specific separators depending on the variable.
  ...
  - **Comma (`,`)**: All other list-type variables, including `CDERUN_GROUP_ADD`, `CDERUN_MOUNT_TOOLS`, `CDERUN_DEVICE`, `CDERUN_PUBLISH`, `CDERUN_EXPOSE`, `CDERUN_DNS`, `CDERUN_DNS_SEARCH`, `CDERUN_DNS_OPTION`, `CDERUN_ADD_HOST`, `CDERUN_CAP_ADD`, `CDERUN_CAP_DROP`, `CDERUN_ENTRYPOINT`, `CDERUN_SENSITIVE_ENV`, `CDERUN_ULIMIT`, `CDERUN_SYSCTL`, `CDERUN_SECURITY_OPT`
