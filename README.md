...
- `--mount-cderun-socket`: Mount cderun Control Socket (`cderun.sock`) into container for nested execution (experimental, supporting Phase 1 protocol framing, Phase 2 non-interactive lifecycle dispatch, and Phase 3 interactive attach/signal/resize). (Default: `false`)
