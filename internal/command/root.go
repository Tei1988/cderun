...
// ExecuteContextWithOptions is like ExecuteContext but allows providing a setup function for rootOptions.
// This is primarily used for testing to inject mocks.
