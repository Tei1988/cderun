...
func TestScenario_Root_Execute_DockerVersion(t *testing.T) {
...
func TestScenario_Root_Execute_Standard(t *testing.T) {
...
func TestScenario_Root_Execute_VolumeMount(t *testing.T) {
	var baseDir string
...
func TestScenario_Root_Execute_Nested(t *testing.T) {
...
func TestScenario_Root_Execute_DryRun(t *testing.T) {
	stdout, stderr, exitCode, err := runCderunE2E(
