...
func TestUnit_Root_StdinPiped(t *testing.T) {
...
func TestUnit_Root_StdinFlowExtended(t *testing.T) {
...
func TestUnit_Root_StdinMocked(t *testing.T) {
	mock := &pipeMockRuntime{MockRuntime: *runtime.NewMockRuntime()}
...
func TestUnit_Root_StdinSynchronization(t *testing.T) {
...
func TestUnit_Root_StdinPipedQuickExit(t *testing.T) {
...
func TestUnit_Root_StdinTTYWait(t *testing.T) {
...
func TestUnit_Root_StdinNonInteractiveQuickExit(t *testing.T) {
...
func TestUnit_Root_StdinPipedLogsContinuous(t *testing.T) {
