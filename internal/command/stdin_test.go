...
func TestIntegration_Root_Stdin_Piped(t *testing.T) {
...
func TestIntegration_Root_Stdin_FlowExtended(t *testing.T) {
...
func TestIntegration_Root_Stdin_Mocked(t *testing.T) {
	mock := &pipeMockRuntime{MockRuntime: *runtime.NewMockRuntime()}
...
func TestIntegration_Root_Stdin_Synchronization(t *testing.T) {
...
func TestIntegration_Root_Stdin_PipedQuickExit(t *testing.T) {
...
func TestIntegration_Root_Stdin_TTYWait(t *testing.T) {
...
func TestIntegration_Root_Stdin_NonInteractiveQuickExit(t *testing.T) {
...
func TestIntegration_Root_Stdin_PipedLogsContinuous(t *testing.T) {
