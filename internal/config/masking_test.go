...
func TestMaskSensitiveEnv(t *testing.T) {
	tests := []struct {
		...
		{"Exact match", "PASSWORD", "secret", "[REDACTED]"},
		...
		{"Acronym API_KEY", "API_KEY", "secret", "[REDACTED]"},
		{"Lowercase camel apiKey", "apiKey", "secret", "[REDACTED]"},
		{"CamelCase sessionId", "sessionId", "secret", "[REDACTED]"},
		{"Monkey case", "monkey", "value", "value"},
