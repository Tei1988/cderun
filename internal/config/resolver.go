...
func getFieldInfo(val reflect.Value, valIdx int) (bool, reflect.Value) {
	v := val.Field(valIdx)
	kind := v.Kind()
	if kind == reflect.Slice || kind == reflect.Ptr || kind == reflect.Interface || kind == reflect.Map {
		if v.IsNil() {
...
func (rv *resolver) applyStringOption(opt StringOption) error {
	...
	switch opt.Name {
	case "image":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunImage != nil, getPtrVal(rv.cli.CderunImage), rv.cli.Image != nil, getPtrVal(rv.cli.Image)
		fastPathUsed = true
	case "network":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunNetwork != nil, getPtrVal(rv.cli.CderunNetwork), rv.cli.Network != nil, getPtrVal(rv.cli.Network)
		fastPathUsed = true
	case "workdir":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunWorkdir != nil, getPtrVal(rv.cli.CderunWorkdir), rv.cli.Workdir != nil, getPtrVal(rv.cli.Workdir)
		fastPathUsed = true
	case "runtime":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunRuntime != nil, getPtrVal(rv.cli.CderunRuntime), rv.cli.Runtime != nil, getPtrVal(rv.cli.Runtime)
		fastPathUsed = true
	case "user":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunUser != nil, getPtrVal(rv.cli.CderunUser), rv.cli.User != nil, getPtrVal(rv.cli.User)
		fastPathUsed = true
	case "log-level":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunLogLevel != nil, getPtrVal(rv.cli.CderunLogLevel), rv.cli.LogLevel != nil, getPtrVal(rv.cli.LogLevel)
		fastPathUsed = true
	case "log-format":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunLogFormat != nil, getPtrVal(rv.cli.CderunLogFormat), rv.cli.LogFormat != nil, getPtrVal(rv.cli.LogFormat)
		fastPathUsed = true
	case "hostname":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunHostname != nil, getPtrVal(rv.cli.CderunHostname), rv.cli.Hostname != nil, getPtrVal(rv.cli.Hostname)
		fastPathUsed = true
	case "pull":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunPull != nil, getPtrVal(rv.cli.CderunPull), rv.cli.Pull != nil, getPtrVal(rv.cli.Pull)
		fastPathUsed = true
	case "dry-run-format":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunDryRunFormat != nil, getPtrVal(rv.cli.CderunDryRunFormat), rv.cli.DryRunFormat != nil, getPtrVal(rv.cli.DryRunFormat)
		fastPathUsed = true
	case "diagnosis-format":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunDiagnosisFormat != nil, getPtrVal(rv.cli.CderunDiagnosisFormat), rv.cli.DiagnosisFormat != nil, getPtrVal(rv.cli.DiagnosisFormat)
		fastPathUsed = true
	}
...
func (rv *resolver) applyBoolOption(opt BoolOption) error {
	...
	switch opt.Name {
	case "tty":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunTTY != nil, getPtrVal(rv.cli.CderunTTY), rv.cli.TTY != nil, getPtrVal(rv.cli.TTY)
		fastPathUsed = true
	case "interactive":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunInteractive != nil, getPtrVal(rv.cli.CderunInteractive), rv.cli.Interactive != nil, getPtrVal(rv.cli.Interactive)
		fastPathUsed = true
	case "remove":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunRemove != nil, getPtrVal(rv.cli.CderunRemove), rv.cli.Remove != nil, getPtrVal(rv.cli.Remove)
		fastPathUsed = true
	case "diagnosis":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunDiagnosis != nil, getPtrVal(rv.cli.CderunDiagnosis), rv.cli.Diagnosis != nil, getPtrVal(rv.cli.Diagnosis)
		fastPathUsed = true
	case "strict-env":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunStrictEnv != nil, getPtrVal(rv.cli.CderunStrictEnv), rv.cli.StrictEnv != nil, getPtrVal(rv.cli.StrictEnv)
		fastPathUsed = true
	case "privileged":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunPrivileged != nil, getPtrVal(rv.cli.CderunPrivileged), rv.cli.Privileged != nil, getPtrVal(rv.cli.Privileged)
		fastPathUsed = true
	case "publish-all":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunPublishAll != nil, getPtrVal(rv.cli.CderunPublishAll), rv.cli.PublishAll != nil, getPtrVal(rv.cli.PublishAll)
		fastPathUsed = true
	case "log-timestamp":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunLogTimestamp != nil, getPtrVal(rv.cli.CderunLogTimestamp), rv.cli.LogTimestamp != nil, getPtrVal(rv.cli.LogTimestamp)
		fastPathUsed = true
	case "mount-socket":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunMountSocket != nil, getPtrVal(rv.cli.CderunMountSocket), rv.cli.MountSocket != nil, getPtrVal(rv.cli.MountSocket)
		fastPathUsed = true
	case "mount-cderun":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunMountCderun != nil, getPtrVal(rv.cli.CderunMountCderun), rv.cli.MountCderun != nil, getPtrVal(rv.cli.MountCderun)
		fastPathUsed = true
	case "mount-all-tools":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunMountAllTools != nil, getPtrVal(rv.cli.CderunMountAllTools), rv.cli.MountAllTools != nil, getPtrVal(rv.cli.MountAllTools)
		fastPathUsed = true
	case "dry-run":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunDryRun != nil, getPtrVal(rv.cli.CderunDryRun), rv.cli.DryRun != nil, getPtrVal(rv.cli.DryRun)
		fastPathUsed = true
	}
...
func (rv *resolver) applyIntOption(opt IntOption) error {
	...
	if opt.Name == "pull-max-retries" && info.p1ValIdx != -1 && info.p2ValIdx != -1 {
		p1Set, p1Int, p2Set, p2Int = rv.cli.CderunPullMaxRetries != nil, getPtrVal(rv.cli.CderunPullMaxRetries), rv.cli.PullMaxRetries != nil, getPtrVal(rv.cli.PullMaxRetries)
...
func (rv *resolver) applyFloat64Option(opt Float64Option) error {
	...
	if opt.Name == "cpus" && info.p1ValIdx != -1 && info.p2ValIdx != -1 {
		p1Set, p1Float, p2Set, p2Float = rv.cli.CderunCPUs != nil, getPtrVal(rv.cli.CderunCPUs), rv.cli.CPUs != nil, getPtrVal(rv.cli.CPUs)
...
func (rv *resolver) applyDurationOption(opt StringOption, target *time.Duration, positive bool) error {
	...
	switch opt.Name {
	case "hang-timeout":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunHangTimeout != nil, getPtrVal(rv.cli.CderunHangTimeout), rv.cli.HangTimeout != nil, getPtrVal(rv.cli.HangTimeout)
	case "pull-backoff-base":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunPullBackoffBase != nil, getPtrVal(rv.cli.CderunPullBackoffBase), rv.cli.PullBackoffBase != nil, getPtrVal(rv.cli.PullBackoffBase)
	default:
...
func (rv *resolver) applyMemoryOption(opt StringOption, target *int64) error {
	...
	switch opt.Name {
	case "memory":
		p1Set, p1Val, p2Set, p2Val = rv.cli.CderunMemory != nil, getPtrVal(rv.cli.CderunMemory), rv.cli.Memory != nil, getPtrVal(rv.cli.Memory)
	default:
		_, s1, v1, s2, v2, err := fetchFieldAndParams(opt.Name, rv.getCliVal())
		if err != nil {
			return err
...
func (rv *resolver) resolveTransitiveOptions() error {
	...
	rv.res.MountTools = resolveStringSliceCommaOpt(
		...
		rv.cli.CderunMountTools != nil, getPtrVal(rv.cli.CderunMountTools),
		rv.cli.MountTools != nil, getPtrVal(rv.cli.MountTools),
