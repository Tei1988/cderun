...
var BoolOptions = []BoolOption{
	...
	},
	{
		...
		Usage:  "If set, requires all passed environment variables to be present on the host",
		ToolGetter: func(t ToolConfig) *bool {
			return t.StrictEnv
		},
		GlobalGetter: func(g CDERunConfig) *bool {
	...
	},
	{
		...
		Usage:  "Mount all tools defined in .tools.yaml into the container",
		ToolGetter: func(t ToolConfig) *bool {
	...
	},
	{
		...
		Usage:  "Mount the cderun binary into the container",
		ToolGetter: func(t ToolConfig) *bool {
...
// GetBoolOption returns a bool option by its kebab-case name.
